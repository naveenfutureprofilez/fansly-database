...
--
-- Host: localhost
-- Generation Time: Feb 09, 2022 at 03:34 PM
...
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `avatar`, `email_verified_at`, `password`, `remember_token`, `settings`, `balance`, `isAdmin`, `ip`, `isBanned`, `created_at`, `updated_at`) VALUES
(22, 'Site Admin', 'admin@example.org', NULL, 'users/default.png', NULL, '$2y$10$W7J09QNB3MY5PlvUSyUNQOEssNDNGF9sQavauc0AUVtcpLleBf3.G', NULL, NULL, 0.00, 'Yes', '127.0.0.1', 'No', '2020-12-04 08:19:47', '2022-02-07 06:34:30'),
(29, 'Naveen Tehpariya', 'naveen@fpdemo.com', '9876543210', 'users/default.png', NULL, '$2y$10$h9i3zF2//C8WWXybCnt5pewABDtiR.6t03Gzfi40BESSYChnccs1m', NULL, NULL, 0.00, 'No', NULL, 'No', '2022-02-09 04:23:25', '2022-02-09 04:23:25');
